	...
	<div class="container">
		<div class="col-md-9 technology-left" style="width:100%">
		  ...
		  <h2 class="w3">SINGLE PAGE</h2>
			<div class="single">
			   <img src="images/sing-1.jpg" class="img-responsive" alt="" style="width:100%">
			    <div class="b-bottom"> 
...
很多人都说背包客是变相的流浪者，但在我看来，背包客跟流浪者有着本质上的差别，流浪没有目的，在更加文艺的角度上讲，流浪是追寻自由的路途，但是背包客是在寻找这世界上无与伦比的美丽，在他们的眼中，每一个村庄的夜晚都是不一样的，每一个城市的霓虹都是不一样的，每一个国家的味道都是不一样的，他们认为世界万物都是独一无二的，即便那些微小的差别看不出来，也不代表这些差别不存在。
			 ...
			 <div class="coment-form">
					...
					<form action="#" method="post">
						<textarea onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '你的评论...';}" required="">你的评论...</textarea>
