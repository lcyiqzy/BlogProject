					...
					<div class="tc-ch wow fadeInDown" data-wow-duration=".8s"
						...
						<div class="soci">
							<ul>
								...
								<li class="hvr-rectangle-out"><a class="twit"
									href="${ctp}/#"></a></li>
								<li class="hvr-rectangle-out"><a class="goog"
									href="${ctp}/#"></a></li>
								<li class="hvr-rectangle-out"><a class="pin"
									href="${ctp}/#"></a></li>
								<li class="hvr-rectangle-out"><a class="drib"
									href="${ctp}/#"></a></li>
							</ul>
						</div>
					...
					<div class="w3ls">
						<div class="col-md-6 w3ls-left wow fadeInDown"
							...
							<div class="tc-ch">
								...
								<div class="soci">
									<ul>
										<li class="hvr-rectangle-out"><a class="fb"
											href="${ctp}/#"></a></li>
										<li class="hvr-rectangle-out"><a class="pin"
											href="${ctp}/#"></a></li>
									</ul>
